        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              {o.verified && (
                <Badge className="bg-blue-100 text-blue-800">{t("provider.opportunities.verifiedClient")}</Badge>
              )}
              {o.hasSubmitted && (
          ...
          <Badge className={`${scoreColor(o.matchScore)} font-semibold text-sm px-3 py-1`}>
            {t("provider.dashboard.opportunity.matchPercent", { n: o.matchScore })}
          </Badge>
        </div>
      </CardHeader>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <span>{t("provider.opportunities.card.jobs", { n: o.clientJobs })}</span><span>•</span>
        ...
        <div className="flex items-center justify-between pt-4 border-t">
          <div className="flex items-center gap-4 text-sm text-gray-500">
            ...
            <span className="inline-flex items-center">
              ...
              {t("provider.dashboard.opportunity.proposalsN", { n: o.proposals })}
            </span>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={onView}>
              <Eye className="w-4 h-4 mr-2" />
              {t("provider.opportunities.viewDetails")}
            </Button>
