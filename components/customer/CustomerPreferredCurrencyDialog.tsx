...
const CURRENCY_PROMPT_PREFIX = "customer_preferred_currency_prompt_seen_v1";
...
type Props = {
  ...
  /** Wait until this page tour is done/skipped before showing (matches CustomerBillingTour). */
  tourStorageKeyPrefix?: string;
};

export function CustomerPreferredCurrencyDialog({
  onSaved,
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="w-[calc(100%-2rem)] max-w-lg p-0 gap-0 overflow-hidden border-0 shadow-2xl rounded-xl sm:rounded-2xl">
        <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 px-5 pt-7 pb-5 text-white">
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-blue-100 mt-2 text-sm">
              Select the currency you prefer for billing reports, stats, and transaction analysis.
            </DialogDescription>
          </DialogHeader>
        </div>
        ...
        <div className="px-5 py-5 bg-white space-y-4">
          <div className="flex items-start gap-3 p-3 rounded-xl bg-blue-50 border border-blue-100">
            ...
            <p className="text-sm text-blue-900">
              Your billing totals and financial summaries will be shown consistently in this
              currency for easier reporting.
            </p>
          </div>
